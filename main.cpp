...
int main() {
    const char* inputPath = "D:/ImgProcessingPipeline/rgbImg.rgb";
    ...
    saveGray("D:/ImgProcessingPipeline/blurred.gray", resultBuffer);
    ...
    myFilter->apply();
    printSmallBlock(resultBuffer);
    saveGray("D:/ImgProcessingPipeline/edges.gray", resultBuffer);
